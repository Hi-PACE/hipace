...
\begin{subequations}
    \begin{align}
    \Delta_x \bm{B_x} &= \frac{n_*}{1+\psi} \bm{B_x} - \bm{e_z} \times \bm{S} \\
    \bm{S}_x &= \frac{1}{1+\psi} B_z \left( \bm{e_z} \times n_* \langle\bm{v_x}\rangle \right) + n_* \langle \bm{\tilde{a}} \rangle - \partial_x\left( n_*\langle v_x^2 \rangle \right) - \partial_y\left( n_*\langle v_y\bm{v_x} \rangle \right) + \bm{\nabla_x}j_z^{total} \\
    n_* \langle \bm{\tilde{a}} \rangle &= \frac{1}{1+\psi} \left(  \frac{n_*\langle\gamma\rangle}{1+\psi}\bm{\nabla_x}\psi - n_* \langle \bm{v_x} \rangle E_z - n_* \langle v_x^2\rangle \partial_x\psi - n_* \langle v_y\bm{v_x}\rangle \partial_y\psi \right) \\
    n_*\langle \gamma\rangle &= \frac{1+\psi}{2}\left(n_*\langle v_x^2\rangle + n_*\langle v_y^2\rangle + n_*\right) + \frac{n_*}{2(1+\psi)}
    \end{align}
\end{subequations}
...
\begin{subequations}
    \begin{align}
    \Delta_y \bm{B_y} &= \frac{n_*}{1+\psi} \bm{B_y} - \bm{e_z} \times \bm{S} \\
    \bm{S}_y &= \frac{1}{1+\psi} B_z \left( \bm{e_z} \times n_* \langle\bm{v_y}\rangle \right) + n_* \langle \bm{\tilde{a}} \rangle - \partial_x\left( n_*\langle v_x\bm{v_y} \rangle \right) - \partial_y\left( n_*\langle v_y^2 \rangle \right) + \bm{\nabla_y}j_z^{total} \\
    n_* \langle \bm{\tilde{a}} \rangle &= \frac{1}{1+\psi} \left(  \frac{n_*\langle\gamma\rangle}{1+\psi}\bm{\nabla_y}\psi - n_* \langle \bm{v_y} \rangle E_z - n_* \langle v_x\bm{v_y}\rangle \partial_x\psi - n_* \langle v_y^2\rangle \partial_y\psi \right) \\
    n_*\langle \gamma\rangle &= \frac{1+\psi}{2}\left(n_*\langle v_x^2\rangle + n_*\langle v_y^2\rangle + n_*\right) + \frac{n_*}{2(1+\psi)}
    \end{align}
\end{subequations}
