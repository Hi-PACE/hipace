...
void
Hipace::SetupPos(openPMD::ParticleSpecies& currSpecies,
...
void
Hipace::SaveRealProperty(BeamParticleIterator& pti,
...
void
Hipace::WriteBeamParticleData (MultiBeam& beams, openPMD::Iteration iteration)
{
...
Hipace::WriteDiagnostics (int output_step, bool force_output)
{
    ...
    WriteBeamParticleData (m_multi_beam, iteration);
