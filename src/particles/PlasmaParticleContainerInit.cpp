    ...
    for(amrex::MFIter mfi = MakeMFIter(lev); mfi.isValid(); ++mfi)
    {
        ...
        [=] AMREX_GPU_DEVICE (int i, int j, int k, const amrex::RandomEngine& engine) noexcept
        {
            ...
            for (int i_part=0; i_part<num_ppc;i_part++)
            {
                ...
                arrdata[PlasmaIdx::Fx1_     ][pidx] = 0.;
                arrdata[PlasmaIdx::Fx2_     ][pidx] = 0.;
                arrdata[PlasmaIdx::Fx3_     ][pidx] = 0.;
                arrdata[PlasmaIdx::Fx4_     ][pidx] = 0.;
                arrdata[PlasmaIdx::Fx5_     ][pidx] = 0.;
                arrdata[PlasmaIdx::Fy1_     ][pidx] = 0.;
                arrdata[PlasmaIdx::Fy2_     ][pidx] = 0.;
                arrdata[PlasmaIdx::Fy3_     ][pidx] = 0.;
                arrdata[PlasmaIdx::Fy4_     ][pidx] = 0.;
                arrdata[PlasmaIdx::Fy5_     ][pidx] = 0.;
                arrdata[PlasmaIdx::Fux1_    ][pidx] = 0.;
                arrdata[PlasmaIdx::Fux2_    ][pidx] = 0.;
                arrdata[PlasmaIdx::Fux3_    ][pidx] = 0.;
                arrdata[PlasmaIdx::Fux4_    ][pidx] = 0.;
                arrdata[PlasmaIdx::Fux5_    ][pidx] = 0.;
                arrdata[PlasmaIdx::Fuy1_    ][pidx] = 0.;
                arrdata[PlasmaIdx::Fuy2_    ][pidx] = 0.;
                arrdata[PlasmaIdx::Fuy3_    ][pidx] = 0.;
                arrdata[PlasmaIdx::Fuy4_    ][pidx] = 0.;
                arrdata[PlasmaIdx::Fuy5_    ][pidx] = 0.;
                arrdata[PlasmaIdx::Fpsi1_   ][pidx] = 0.;
                arrdata[PlasmaIdx::Fpsi2_   ][pidx] = 0.;
                arrdata[PlasmaIdx::Fpsi3_   ][pidx] = 0.;
                arrdata[PlasmaIdx::Fpsi4_   ][pidx] = 0.;
                arrdata[PlasmaIdx::Fpsi5_   ][pidx] = 0.;
