    ...
    for (amrex::MFIter mfi_ion = MakeMFIter(lev); mfi_ion.isValid(); ++mfi_ion)
    {
        ...
        amrex::ParallelFor(num_ions,
            ...
            if(p_ion_mask[ip] != 0) {
                ...
                // order of force thermes doesn't matter
                arrdata_elec[PlasmaIdx::Fx1_    ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fx2_    ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fx3_    ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fx4_    ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fx5_    ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fy1_    ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fy2_    ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fy3_    ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fy4_    ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fy5_    ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fux1_   ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fux2_   ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fux3_   ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fux4_   ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fux5_   ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fuy1_   ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fuy2_   ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fuy3_   ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fuy4_   ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fuy5_   ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fpsi1_  ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fpsi2_  ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fpsi3_  ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fpsi4_  ][pidx] = 0._rt;
                arrdata_elec[PlasmaIdx::Fpsi5_  ][pidx] = 0._rt;
